...
namespace PlayFab.PlayFabPlus
{
    public static class PlayFabPlusCore
    {
        ...
        public static void LoginWithCustomID(Action OnLoginSuccessAction, Action OnLoginFailedAction, Dictionary<string, string> CustomTags = null,
            GetPlayerCombinedInfoRequestParams InfoParms = null, string customID = null)
        {
            if(customID == null)
            {
